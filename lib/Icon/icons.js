...
export default {
  ...
  'clearX': ({ style, className }) => {
    console.warn(
      'Warning: "clearX" is a deprecated icon and will be removed in the next major version of @folio/stripes-components.\n' +
      'Use "clear-x" instead.\n'
    );
    return (
      <svg focusable="false" style={style} className={className} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
  ...
  'closeX': ({ style, className }) => {
    console.warn(
      'Warning: "closeX" is a deprecated icon and will be removed in the next major version of @folio/stripes-components.\n' +
      'Use "close-x" instead.\n'
    );
    return (
      <svg focusable="false" style={style} className={className} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
  ...
  'down-arrow': ({ style, className }) => {
    console.warn(
      'Warning: "down-arrow" is a deprecated icon and will be removed in the next major version of @folio/stripes-components.\n' +
      'Use "arrow-down" instead.\n'
    );
    return (
      <svg focusable="false" style={style} className={className} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
        <path d="M8.161 11.838a.999.999 0 1 0-1.414 1.414l4.842 4.843a1.004 1.004 0 0 0 1.093.217.993.993 0 0 0 .323-.217l4.842-4.843a.999.999 0 1 0-1.414-1.414l-3.137 3.137v-9.96a1 1 0 1 0-2 0v9.96l-3.135-3.137z" />
  ...
  'down-caret': ({ style, className }) => {
    console.warn(
      'Warning: "down-caret" is a deprecated icon and will be removed in the next major version of @folio/stripes-components.\n' +
      'Use "chevron-down" instead.\n'
    );
    return (
      <svg focusable="false" style={style} className={className} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
        <path d="M11.293 15.546a.997.997 0 0 0 1.414 0l4.844-4.844a.999.999 0 1 0-1.414-1.414L12 13.425 7.863 9.288a.999.999 0 1 0-1.414 1.414l4.844 4.844z" />
  ...
  'down-triangle': ({ style, className }) => {
    console.warn(
      'Warning: "down-triangle" is a deprecated icon and will be removed in the next major version of @folio/stripes-components.\n' +
      'Use "caret-down" instead.\n'
    );
    return (
      <svg focusable="false" style={style} className={className} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
        <path d="M12 14.839l4.844-4.844H7.156z" />
  ...
  'external-link': ({ style, className }) => (
    <svg focusable="false" style={style} className={className} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
      <path d="M19 5.9c-.2-.4-.5-.6-.9-.6h-3.8c-.6 0-1 .4-1 1s.4 1 1 1h1.3l-6.2 6.2c-.4.4-.4 1 0 1.4.4.4 1 .4 1.4 0L17 8.7V10c0 .6.4 1 1 1s1-.4 1-1V6.2c.1-.1.1-.2 0-.3z"/>
      <path d="M16.7 14.2c-.6 0-1 .4-1 1v1.6H7.6V8.6h1.6c.6 0 1-.4 1-1s-.4-1-1-1H6.6c-.6 0-1 .4-1 1v10.1c0 .6.4 1 1 1h10.1c.6 0 1-.4 1-1v-2.6c0-.5-.4-.9-1-.9z"/>
    </svg>
  ),
  ...
  'hollowX': ({ style, className }) => {
    console.warn(
      'Warning: "hollowX" is a deprecated icon and will be removed in the next major version of @folio/stripes-components.\n' +
      'Use "hollow-x" instead.\n'
    );
    return (
      <svg focusable="false" style={style} className={className} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
        <path d="M12 4.847c-3.944 0-7.153 3.209-7.153 7.153S8.056 19.153 12 19.153s7.153-3.209 7.153-7.153S15.944 4.847 12 4.847zm0 12.306c-2.841 0-5.153-2.312-5.153-5.153S9.159 6.847 12 6.847 17.153 9.158 17.153 12 14.841 17.153 12 17.153z" />
  ...
  'info': ({ style, className }) => (
    <svg focusable="false" style={style} className={className} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
      <path d="M12 18.6c3.9 0 7.1-3.2 7.1-7.1S15.9 4.4 12 4.4s-7.1 3.2-7.1 7.1 3.2 7.1 7.1 7.1zm0-12.7c3.1 0 5.6 2.5 5.6 5.6s-2.5 5.6-5.6 5.6-5.6-2.5-5.6-5.6S8.9 5.9 12 5.9z"/>
      <path d="M12 10.6c-.4 0-.8.3-.8.8v3c0 .4.3.8.8.8.4 0 .8-.3.8-.8v-3c0-.5-.4-.8-.8-.8z"/>
      <circle cx="12" cy="8.7" r=".9"/>
    </svg>
  ),
  'left-arrow': ({ style, className }) => {
    console.warn(
      'Warning: "left-arrow" is a deprecated icon and will be removed in the next major version of @folio/stripes-components.\n' +
      'Use "arrow-left" instead.\n'
    );
    return (
      <svg focusable="false" style={style} className={className} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
        <path d="M18.687 11H8.728l3.137-3.137a.999.999 0 1 0-1.414-1.414l-4.842 4.842a1.001 1.001 0 0 0 0 1.416l4.842 4.842a.997.997 0 0 0 1.414 0 .999.999 0 0 0 0-1.414L8.728 13h9.959a1 1 0 1 0 0-2z" />
  ...
  'left-double-chevron': ({ style, className }) => {
    console.warn(
      'Warning: "left-double-chevron" is a deprecated icon and will be removed in the next major version of @folio/stripes-components.\n' +
      'Use "chevron-double-left" instead.\n'
    );
    return (
      <svg focusable="false" style={style} className={className} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
        <path d="M17.584 6.449a.999.999 0 0 0-1.414 0l-4.844 4.844a.997.997 0 0 0 0 1.414l4.844 4.844a.997.997 0 0 0 1.414 0 .999.999 0 0 0 0-1.414L13.447 12l4.137-4.137a.999.999 0 0 0 0-1.414z" />
  ...
  'right-arrow': ({ style, className }) => {
    console.warn(
      'Warning: "right-arrow" is a deprecated icon and will be removed in the next major version of @folio/stripes-components.\n' +
      'Use "arrow-right" instead.\n'
    );
    return (
      <svg focusable="false" style={style} className={className} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
        <path d="M18.61 11.618a1.021 1.021 0 0 0-.217-.327L13.55 6.449a.999.999 0 1 0-1.414 1.414L15.272 11H5.313a1 1 0 1 0 0 2h9.959l-3.137 3.137a.999.999 0 1 0 1.414 1.414l4.842-4.842a.99.99 0 0 0 .217-.326.995.995 0 0 0 .002-.765z" />
  ...
  'right-double-chevron': ({ style, className }) => {
    console.warn(
      'Warning: "right-double-chevron" is a deprecated icon and will be removed in the next major version of @folio/stripes-components.\n' +
      'Use "chevron-double-right" instead.\n'
    );
    return (
      <svg focusable="false" style={style} className={className} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
        <path d="M12.674 11.293L7.83 6.449a.999.999 0 1 0-1.414 1.414L10.553 12l-4.137 4.137a.999.999 0 1 0 1.414 1.414l4.844-4.844a1 1 0 0 0 0-1.414z" />
  ...
  'trashBin': ({ style, className }) => {
    console.warn(
      'Warning: "trashBin" is a deprecated icon and will be removed in the next major version of @folio/stripes-components.\n' +
      'Use "trash" instead.\n'
    );
    return (
      <svg focusable="false" style={style} className={className} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
  ...
  'up-arrow': ({ style, className }) => {
    console.warn(
      'Warning: "up-arrow" is a deprecated icon and will be removed in the next major version of @folio/stripes-components.\n' +
      'Use "arrow-up" instead.\n'
    );
    return (
      <svg focusable="false" style={style} className={className} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
        <path d="M12.409 5.308a.997.997 0 0 0-1.414 0l-4.843 4.844a.999.999 0 1 0 1.414 1.414l3.137-3.137v9.96a1 1 0 1 0 2 0v-9.96l3.137 3.137a.997.997 0 0 0 1.414 0 .999.999 0 0 0 0-1.414l-4.845-4.844z" />
  ...
  'up-caret': ({ style, className }) => {
    console.warn(
      'Warning: "up-caret" is a deprecated icon and will be removed in the next major version of @folio/stripes-components.\n' +
      'Use "chevron-up" instead.\n'
    );
    return (
      <svg focusable="false" style={style} className={className} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
        <path d="M11.293 8.454l-4.844 4.844a.999.999 0 1 0 1.414 1.414L12 10.575l4.137 4.137a.997.997 0 0 0 1.414 0 .999.999 0 0 0 0-1.414l-4.844-4.844a.999.999 0 0 0-1.414 0z" />
  ...
  'up-triangle': ({ style, className }) => {
    console.warn(
      'Warning: "up-triangle" is a deprecated icon and will be removed in the next major version of @folio/stripes-components.\n' +
      'Use "caret-up" instead.\n'
    );
    return (
      <svg focusable="false" style={style} className={className} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
        <path d="M12 9.161l-4.844 4.844h9.688z" />
