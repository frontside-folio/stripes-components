...
class TextField extends Component {
  ...
  render() {
    ...
    if (this.props.hasClearIcon
      ...
      clearField = (
        <FormattedMessage
          id="stripes-components.clearThisField"
    ...
    if (this.props.validStylesEnabled
      ...
      validation = (
        <FormattedMessage
          id="stripes-components.fieldIsValid"
          defaultMessage="Field is valid"
        >
          {ariaLabel => (
            <TextFieldIcon
              ariaLabel={ariaLabel}
    ...
    if (validationEnabled && this.props.error) {
      validation = (
        <FormattedMessage
          id="stripes-components.fieldHasError"
          defaultMessage="Field has error"
        >
          {ariaLabel => (
            <TextFieldIcon
              ariaLabel={ariaLabel}
    ...
    if (this.props.loading) {
      validation = (
        <FormattedMessage
          id="stripes-components.validatingInProcess"
